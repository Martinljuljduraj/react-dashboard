...
var U = function(l3) {
  var r3 = l3.elementRef, u5 = l3.nodes, a2 = l3.getNodePosition, h = void 0 === a2 ? D2 : a2, c = l3.delaunay, v2 = l3.setCurrent, f = l3.margin, p = void 0 === f ? L2 : f, g = l3.detectionRadius, m2 = void 0 === g ? 1 / 0 : g, b2 = l3.isInteractive, k2 = void 0 === b2 || b2, C3 = l3.onMouseEnter, y2 = l3.onMouseMove, w3 = l3.onMouseLeave, R2 = l3.onMouseDown, W3 = l3.onMouseUp, E4 = l3.onClick, x2 = l3.onDoubleClick, S2 = l3.onTouchStart, U3 = l3.onTouchMove, z3 = l3.onTouchEnd, A2 = l3.enableTouchCrosshair, N2 = void 0 !== A2 && A2, H2 = l3.tooltip, O3 = l3.tooltipPosition, I2 = void 0 === O3 ? T2 : O3, j4 = l3.tooltipAnchor, F2 = void 0 === j4 ? P : j4, B2 = (0, import_react.useState)(null), q3 = B2[0], G = B2[1], J = (0, import_react.useRef)(null);
  ...
  }, [r3, c, u5, h, p, m2]), Q = z2(), V3 = Q.showTooltipAt, X2 = Q.showTooltipFromEvent, Y2 = Q.hideTooltip, Z = (0, import_react.useMemo)(function() {
  ...
  }, [K, G, E4]), ln2 = (0, import_react.useCallback)(function(n3) {
    var o3 = K(n3);
...
var j2 = function(o3) {
  var i3 = o3.nodes, t3 = o3.width, l3 = o3.height, r3 = o3.margin, u5 = void 0 === r3 ? L2 : r3, a2 = o3.getNodePosition, d = o3.setCurrent, s2 = o3.onMouseEnter, h = o3.onMouseMove, c = o3.onMouseLeave, v2 = o3.onMouseDown, f = o3.onMouseUp, p = o3.onClick, g = o3.onDoubleClick, M = o3.onTouchStart, C3 = o3.onTouchMove, y2 = o3.onTouchEnd, w3 = o3.enableTouchCrosshair, D3 = void 0 !== w3 && w3, R2 = o3.detectionRadius, W3 = void 0 === R2 ? 1 / 0 : R2, x2 = o3.tooltip, S2 = o3.tooltipPosition, z3 = void 0 === S2 ? T2 : S2, A2 = o3.tooltipAnchor, N2 = void 0 === A2 ? P : A2, H2 = o3.debug, O3 = (0, import_react.useRef)(null), I2 = E3({ points: i3, getNodePosition: a2, width: t3, height: l3, margin: u5, debug: H2 }), j4 = I2.delaunay, F2 = I2.voronoi, B2 = U({ elementRef: O3, nodes: i3, delaunay: j4, margin: u5, detectionRadius: W3, setCurrent: d, onMouseEnter: s2, onMouseMove: h, onMouseLeave: c, onMouseDown: v2, onMouseUp: f, onClick: p, onDoubleClick: g, onTouchStart: M, onTouchMove: C3, onTouchEnd: y2, enableTouchCrosshair: D3, tooltip: x2, tooltipPosition: z3, tooltipAnchor: N2 }), q3 = B2.current, G = B2.handleMouseEnter, J = B2.handleMouseMove, K = B2.handleMouseLeave, Q = B2.handleMouseDown, V3 = B2.handleMouseUp, X2 = B2.handleClick, Y2 = B2.handleDoubleClick, Z = B2.handleTouchStart, $2 = B2.handleTouchMove, _2 = B2.handleTouchEnd, nn = (0, import_react.useMemo)(function() {
...
var oe = { xScale: { type: "point" }, yScale: { type: "linear", min: 0, max: "auto" }, curve: "linear", colors: { scheme: "nivo" }, lineWidth: 2, layers: ["grid", "markers", "axes", "areas", "crosshair", "lines", "points", "slices", "mesh", "legends"], enablePoints: true, pointSize: 6, pointColor: { from: "series.color" }, pointBorderWidth: 0, pointBorderColor: { theme: "background" }, enableArea: false, areaBaselineValue: 0, areaOpacity: 0.2, enableGridX: true, enableGridY: true, legends: [], isInteractive: true, tooltip: (0, import_react2.memo)(function(e3) {
  ...
  var o3 = e3.slice, i3 = e3.axis, n3 = z(), t3 = "x" === i3 ? "y" : "x";
...
var le = "line";
var se = function(e3) {
  var t3 = e3.data, r3 = e3.xScale, a2 = void 0 === r3 ? oe.xScale : r3, l3 = e3.xFormat, s2 = e3.yScale, u5 = void 0 === s2 ? oe.yScale : s2, c = e3.yFormat, h = e3.width, f = e3.height, p = e3.colors, v2 = void 0 === p ? oe.colors : p, b2 = e3.curve, g = void 0 === b2 ? oe.curve : b2, m2 = e3.areaBaselineValue, y2 = void 0 === m2 ? oe.areaBaselineValue : m2, x2 = e3.pointColor, M = void 0 === x2 ? oe.pointColor : x2, C3 = e3.pointBorderColor, S2 = void 0 === C3 ? oe.pointBorderColor : C3, B2 = e3.enableSlices, w3 = void 0 === B2 ? ie.enableSlices : B2, T3 = e3.initialHiddenIds, k2 = void 0 === T3 ? ie.initialHiddenIds : T3, W3 = (0, import_react2.useState)((0, import_uniqueId.default)(le))[0], L3 = hn(l3), D3 = hn(c), I2 = pr(v2, "id"), F2 = z(), E4 = Ye(M, F2), G = Ye(S2, F2), H2 = (0, import_react2.useState)(null != k2 ? k2 : []), P2 = H2[0], R2 = H2[1], U3 = (0, import_react2.useMemo)(function() {
    return ln(t3.filter(function(e4) {
...
var fe = (0, import_react2.memo)(function(e3) {
  var o3 = e3.slice, i3 = e3.slices, r3 = e3.axis, a2 = e3.debug, l3 = e3.tooltip, s2 = e3.isCurrent, u5 = e3.setCurrent, d = e3.onMouseEnter, c = e3.onMouseMove, h = e3.onMouseLeave, f = e3.onMouseDown, p = e3.onMouseUp, v2 = e3.onClick, b2 = e3.onDoubleClick, g = e3.onTouchStart, m2 = e3.onTouchMove, y2 = e3.onTouchEnd, x2 = z2(), M = x2.showTooltipFromEvent, C3 = x2.hideTooltip, S2 = (0, import_react2.useCallback)(function(e4) {
    M((0, import_react2.createElement)(l3, { slice: o3, axis: r3 }), e4, "right"), u5(o3), null == d || d(o3, e4);
  }, [M, l3, o3, r3, u5, d]), B2 = (0, import_react2.useCallback)(function(e4) {
    M((0, import_react2.createElement)(l3, { slice: o3, axis: r3 }), e4, "right"), null == c || c(o3, e4);
  }, [M, l3, o3, r3, c]), w3 = (0, import_react2.useCallback)(function(e4) {
    ...
    M((0, import_react2.createElement)(l3, { slice: o3, axis: r3 }), e4, "right"), u5(o3), null == g || g(o3, e4);
  }, [r3, g, u5, M, o3, l3]), I2 = (0, import_react2.useCallback)(function(e4) {
    ...
    if (s3) {
      ...
      d2 && (M((0, import_react2.createElement)(l3, { slice: d2, axis: r3 }), e4, "right"), u5(d2));
    }
    null == m2 || m2(o3, e4);
  }, [r3, m2, u5, M, o3, i3, l3]), F2 = (0, import_react2.useCallback)(function(e4) {
...
var ve = (0, import_react2.memo)(function(e3) {
  var o3 = e3.points, i3 = e3.symbol, n3 = e3.size, r3 = e3.borderWidth, a2 = e3.enableLabel, l3 = e3.label, s2 = e3.labelYOffset, u5 = e3.isFocusable, d = e3.setCurrentPoint, c = e3.tooltip, h = e3.margin, v2 = e3.ariaLabel, b2 = e3.ariaLabelledBy, g = e3.ariaDescribedBy, m2 = e3.ariaHidden, y2 = e3.ariaDisabled, x2 = pn(l3), M = z2(), C3 = M.showTooltipAt, S2 = M.hideTooltip, B2 = o3.slice(0).sort(function(e4, o4) {
...
var Se = function(e3) {
  ...
  var eo = (0, import_react2.useCallback)(function(e4) {
    ...
    return Ne[t3];
  }, [Fe, Ge, He, Pe, $e, Ne]), oo = z2(), io = oo.showTooltipFromEvent, no = oo.hideTooltip, to = (0, import_react2.useCallback)(function(e4) {
    var o3 = eo(e4);
