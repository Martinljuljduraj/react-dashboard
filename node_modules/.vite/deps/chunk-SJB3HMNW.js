...
function isEqual(a7, b4) {
  if (is.arr(a7)) {
    if (!is.arr(b4) || a7.length !== b4.length)
      return false;
...
var toArray = (a7) => is.und(a7) ? [] : is.arr(a7) ? a7 : [a7];
...
function colorToRgba(input) {
  ...
  const a7 = (int32Color & 255) / 255;
  return `rgba(${r5}, ${g2}, ${b4}, ${a7})`;
}
...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort2)) {
    transitions.sort((a7, b4) => sort2(a7.item, b4.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
...
function c(e8, u5, c10) {
  var i5 = this, a7 = (0, import_react17.useRef)(null), o5 = (0, import_react17.useRef)(0), f4 = (0, import_react17.useRef)(null), l5 = (0, import_react17.useRef)([]), v4 = (0, import_react17.useRef)(), m3 = (0, import_react17.useRef)(), d4 = (0, import_react17.useRef)(e8), g2 = (0, import_react17.useRef)(true);
  d4.current = e8;
  var p4 = "undefined" != typeof window, w3 = !u5 && 0 !== u5 && p4;
  if ("function" != typeof e8) throw new TypeError("Expected a function");
  u5 = +u5 || 0;
  var s6 = !!(c10 = c10 || {}).leading, x3 = !("trailing" in c10) || !!c10.trailing, h2 = "maxWait" in c10, y5 = "debounceOnServer" in c10 && !!c10.debounceOnServer, F2 = h2 ? Math.max(+c10.maxWait || 0, u5) : null;
  (0, import_react17.useEffect)(function() {
    return g2.current = true, function() {
      g2.current = false;
    };
  }, []);
  var A4 = (0, import_react17.useMemo)(function() {
    var r5 = function(r6) {
      var n7 = l5.current, t8 = v4.current;
      return l5.current = v4.current = null, o5.current = r6, m3.current = d4.current.apply(t8, n7);
    }, n6 = function(r6, n7) {
      w3 && cancelAnimationFrame(f4.current), f4.current = w3 ? requestAnimationFrame(r6) : setTimeout(r6, n7);
    }, t7 = function(r6) {
      if (!g2.current) return false;
      var n7 = r6 - a7.current;
      return !a7.current || n7 >= u5 || n7 < 0 || h2 && r6 - o5.current >= F2;
    }, e9 = function(n7) {
      return f4.current = null, x3 && l5.current ? r5(n7) : (l5.current = v4.current = null, m3.current);
    }, c11 = function r6() {
      var c12 = Date.now();
      if (t7(c12)) return e9(c12);
      if (g2.current) {
        var i6 = u5 - (c12 - a7.current), f5 = h2 ? Math.min(i6, F2 - (c12 - o5.current)) : i6;
        n6(r6, f5);
      }
    }, A5 = function() {
      if (p4 || y5) {
        var e11 = Date.now(), d5 = t7(e11);
        if (l5.current = [].slice.call(arguments), v4.current = i5, a7.current = e11, d5) {
          if (!f4.current && g2.current) return o5.current = a7.current, n6(c11, u5), s6 ? r5(a7.current) : m3.current;
          if (h2) return n6(c11, u5), r5(a7.current);
        }
        return f4.current || n6(c11, u5), m3.current;
      }
    };
    return A5.cancel = function() {
      f4.current && (w3 ? cancelAnimationFrame(f4.current) : clearTimeout(f4.current)), o5.current = 0, l5.current = a7.current = v4.current = f4.current = null;
    }, A5.isPending = function() {
      return !!f4.current;
    }, A5.flush = function() {
      return f4.current ? e9(Date.now()) : m3.current;
    }, A5;
  }, [s6, h2, u5, F2, x3, w3, p4, y5]);
  return A4;
}
function i2(r5, n6) {
  return r5 === n6;
}
function a2(n6, t7, a7) {
  var o5 = a7 && a7.equalityFn || i2, f4 = (0, import_react17.useRef)(n6), l5 = (0, import_react17.useState)({})[1], v4 = c((0, import_react17.useCallback)(function(r5) {
    f4.current = r5, l5({});
  }, [l5]), t7, a7), m3 = (0, import_react17.useRef)(n6);
  return o5(m3.current, n6) || (v4(n6), m3.current = n6), [f4.current, v4];
}
...
function rgba2(r5, g2, b4, a7) {
  if (a7 <= 0) r5 = g2 = b4 = NaN;
  return new Rgb(r5, g2, b4, a7);
}
...
function rgb2(r5, g2, b4, opacity) {
  return arguments.length === 1 ? rgbConvert(r5) : new Rgb(r5, g2, b4, opacity == null ? 1 : opacity);
}
function Rgb(r5, g2, b4, opacity) {
  this.r = +r5;
  this.g = +g2;
  this.b = +b4;
...
function hsla2(h2, s6, l5, a7) {
  if (a7 <= 0) h2 = s6 = l5 = NaN;
  else if (l5 <= 0 || l5 >= 1) h2 = s6 = NaN;
  else if (s6 <= 0) h2 = NaN;
  return new Hsl(h2, s6, l5, a7);
}
function hslConvert(o5) {
  ...
  o5 = o5.rgb();
  var r5 = o5.r / 255, g2 = o5.g / 255, b4 = o5.b / 255, min3 = Math.min(r5, g2, b4), max3 = Math.max(r5, g2, b4), h2 = NaN, s6 = max3 - min3, l5 = (max3 + min3) / 2;
  if (s6) {
    if (r5 === max3) h2 = (g2 - b4) / s6 + (g2 < b4) * 6;
    else if (g2 === max3) h2 = (b4 - r5) / s6 + 2;
    else h2 = (r5 - g2) / s6 + 4;
...
function labConvert(o5) {
  ...
  var r5 = rgb2lrgb(o5.r), g2 = rgb2lrgb(o5.g), b4 = rgb2lrgb(o5.b), y5 = xyz2lab((0.2225045 * r5 + 0.7168786 * g2 + 0.0606169 * b4) / Yn), x3, z5;
  if (r5 === g2 && g2 === b4) x3 = z5 = y5;
  else {
    x3 = xyz2lab((0.4360747 * r5 + 0.3850649 * g2 + 0.1430804 * b4) / Xn);
    z5 = xyz2lab((0.0139322 * r5 + 0.0971045 * g2 + 0.7141733 * b4) / Zn);
  }
  return new Lab(116 * y5 - 16, 500 * (x3 - y5), 200 * (y5 - z5), o5.opacity);
}
function lab(l5, a7, b4, opacity) {
  return arguments.length === 1 ? labConvert(l5) : new Lab(l5, a7, b4, opacity == null ? 1 : opacity);
}
function Lab(l5, a7, b4, opacity) {
  this.l = +l5;
  this.a = +a7;
...
function cubehelixConvert(o5) {
  ...
  if (!(o5 instanceof Rgb)) o5 = rgbConvert(o5);
  var r5 = o5.r / 255, g2 = o5.g / 255, b4 = o5.b / 255, l5 = (BC_DA * b4 + ED * r5 - EB * g2) / (BC_DA + ED - EB), bl = b4 - l5, k5 = (E * (g2 - l5) - C2 * bl) / D, s6 = Math.sqrt(k5 * k5 + bl * bl) / (E * l5 * (1 - l5)), h2 = s6 ? Math.atan2(k5, bl) * degrees - 120 : NaN;
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l5 = +this.l, a7 = isNaN(this.s) ? 0 : this.s * l5 * (1 - l5), cosh2 = Math.cos(h2), sinh2 = Math.sin(h2);
    return new Rgb(
      255 * (l5 + a7 * (A * cosh2 + B * sinh2)),
      255 * (l5 + a7 * (C2 * cosh2 + D * sinh2)),
      255 * (l5 + a7 * (E * cosh2)),
      this.opacity
    );
  }
...
function basis_default(values) {
  ...
  return function(t7) {
    var i5 = t7 <= 0 ? t7 = 0 : t7 >= 1 ? (t7 = 1, n6 - 1) : Math.floor(t7 * n6), v1 = values[i5], v22 = values[i5 + 1], v0 = i5 > 0 ? values[i5 - 1] : 2 * v1 - v22, v32 = i5 < n6 - 1 ? values[i5 + 2] : 2 * v22 - v1;
    return basis((t7 - i5 / n6) * n6, v0, v1, v22, v32);
  };
}
...
function basisClosed_default(values) {
  ...
  return function(t7) {
    var i5 = Math.floor(((t7 %= 1) < 0 ? ++t7 : t7) * n6), v0 = values[(i5 + n6 - 1) % n6], v1 = values[i5 % n6], v22 = values[(i5 + 1) % n6], v32 = values[(i5 + 2) % n6];
    return basis((t7 - i5 / n6) * n6, v0, v1, v22, v32);
  };
}
...
function linear(a7, d4) {
  return function(t7) {
    return a7 + t7 * d4;
  };
}
function exponential(a7, b4, y5) {
  return a7 = Math.pow(a7, y5), b4 = Math.pow(b4, y5) - a7, y5 = 1 / y5, function(t7) {
    return Math.pow(a7 + t7 * b4, y5);
  };
}
function hue(a7, b4) {
  var d4 = b4 - a7;
  return d4 ? linear(a7, d4 > 180 || d4 < -180 ? d4 - 360 * Math.round(d4 / 360) : d4) : constant_default(isNaN(a7) ? b4 : a7);
}
function gamma(y5) {
  return (y5 = +y5) === 1 ? nogamma : function(a7, b4) {
    return b4 - a7 ? exponential(a7, b4, y5) : constant_default(isNaN(a7) ? b4 : a7);
  };
}
function nogamma(a7, b4) {
  var d4 = b4 - a7;
  return d4 ? linear(a7, d4) : constant_default(isNaN(a7) ? b4 : a7);
}
...
var rgb_default = function rgbGamma(y5) {
  ...
  function rgb3(start2, end) {
    var r5 = color2((start2 = rgb2(start2)).r, (end = rgb2(end)).r), g2 = color2(start2.g, end.g), b4 = color2(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r5(t7);
      start2.g = g2(t7);
      start2.b = b4(t7);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n6 = colors3.length, r5 = new Array(n6), g2 = new Array(n6), b4 = new Array(n6), i5, color2;
    for (i5 = 0; i5 < n6; ++i5) {
...
function numberArray_default(a7, b4) {
  if (!b4) b4 = [];
  var n6 = a7 ? Math.min(b4.length, a7.length) : 0, c10 = b4.slice(), i5;
  return function(t7) {
    for (i5 = 0; i5 < n6; ++i5) c10[i5] = a7[i5] * (1 - t7) + b4[i5] * t7;
    return c10;
  };
}
...
function genericArray(a7, b4) {
  var nb = b4 ? b4.length : 0, na = a7 ? Math.min(nb, a7.length) : 0, x3 = new Array(na), c10 = new Array(nb), i5;
  for (i5 = 0; i5 < na; ++i5) x3[i5] = value_default(a7[i5], b4[i5]);
  for (; i5 < nb; ++i5) c10[i5] = b4[i5];
  return function(t7) {
...
function date_default(a7, b4) {
  var d4 = /* @__PURE__ */ new Date();
  return a7 = +a7, b4 = +b4, function(t7) {
    return d4.setTime(a7 * (1 - t7) + b4 * t7), d4;
  };
}

// node_modules/d3-interpolate/src/number.js
function number_default(a7, b4) {
  return a7 = +a7, b4 = +b4, function(t7) {
    return a7 * (1 - t7) + b4 * t7;
  };
}

// node_modules/d3-interpolate/src/object.js
function object_default(a7, b4) {
  var i5 = {}, c10 = {}, k5;
  if (a7 === null || typeof a7 !== "object") a7 = {};
  if (b4 === null || typeof b4 !== "object") b4 = {};
  for (k5 in b4) {
    if (k5 in a7) {
      i5[k5] = value_default(a7[k5], b4[k5]);
    } else {
      c10[k5] = b4[k5];
    }
  }
  return function(t7) {
    for (k5 in i5) c10[k5] = i5[k5](t7);
    return c10;
  };
}
...
function string_default(a7, b4) {
  var bi = reA.lastIndex = reB.lastIndex = 0, am, bm, bs, i5 = -1, s6 = [], q = [];
  a7 = a7 + "", b4 = b4 + "";
  while ((am = reA.exec(a7)) && (bm = reB.exec(b4))) {
    if ((bs = bm.index) > bi) {
      bs = b4.slice(bi, bs);
      if (s6[i5]) s6[i5] += bs;
      else s6[++i5] = bs;
  ...
  return s6.length < 2 ? q[0] ? one(q[0].x) : zero(b4) : (b4 = q.length, function(t7) {
    for (var i6 = 0, o5; i6 < b4; ++i6) s6[(o5 = q[i6]).i] = o5.x(t7);
    return s6.join("");
  });
}

// node_modules/d3-interpolate/src/value.js
function value_default(a7, b4) {
  var t7 = typeof b4, c10;
  return b4 == null || t7 === "boolean" ? constant_default(b4) : (t7 === "number" ? number_default : t7 === "string" ? (c10 = color(b4)) ? (b4 = c10, rgb_default) : string_default : b4 instanceof color ? rgb_default : b4 instanceof Date ? date_default : isNumberArray(b4) ? numberArray_default : Array.isArray(b4) ? genericArray : typeof b4.valueOf !== "function" && typeof b4.toString !== "function" || isNaN(b4) ? object_default : number_default)(a7, b4);
}

// node_modules/d3-interpolate/src/round.js
function round_default(a7, b4) {
  return a7 = +a7, b4 = +b4, function(t7) {
    return Math.round(a7 * (1 - t7) + b4 * t7);
  };
}
...
function decompose_default(a7, b4, c10, d4, e8, f4) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a7 * a7 + b4 * b4)) a7 /= scaleX, b4 /= scaleX;
  if (skewX = a7 * c10 + b4 * d4) c10 -= a7 * skewX, d4 -= b4 * skewX;
  if (scaleY = Math.sqrt(c10 * c10 + d4 * d4)) c10 /= scaleY, d4 /= scaleY, skewX /= scaleY;
  if (a7 * d4 < b4 * c10) a7 = -a7, b4 = -b4, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e8,
    translateY: f4,
    rotate: Math.atan2(b4, a7) * degrees2,
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a7, b4, s6, q) {
    if (a7 !== b4) {
      if (a7 - b4 > 180) b4 += 360;
      else if (b4 - a7 > 180) a7 += 360;
      q.push({ i: s6.push(pop(s6) + "rotate(", null, degParen) - 2, x: number_default(a7, b4) });
    } else if (b4) {
      s6.push(pop(s6) + "rotate(" + b4 + degParen);
    }
  }
  function skewX(a7, b4, s6, q) {
    if (a7 !== b4) {
      q.push({ i: s6.push(pop(s6) + "skewX(", null, degParen) - 2, x: number_default(a7, b4) });
    } else if (b4) {
      s6.push(pop(s6) + "skewX(" + b4 + degParen);
    }
  }
  ...
  return function(a7, b4) {
    var s6 = [], q = [];
    a7 = parse(a7), b4 = parse(b4);
    translate(a7.translateX, a7.translateY, b4.translateX, b4.translateY, s6, q);
    rotate(a7.rotate, b4.rotate, s6, q);
    skewX(a7.skewX, b4.skewX, s6, q);
    scale(a7.scaleX, a7.scaleY, b4.scaleX, b4.scaleY, s6, q);
    a7 = b4 = null;
    return function(t7) {
...
function appendRound(digits) {
  ...
  return function(strings) {
    this._ += strings[0];
    for (let i5 = 1, n6 = strings.length; i5 < n6; ++i5) {
      this._ += Math.round(arguments[i5] * k5) / k5 + strings[i5];
    }
  };
}
var Path = class {
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d22 = dx * dx + dy * dy, r5 = r1 - rc, D2 = x11 * y10 - x10 * y11, d4 = (dy < 0 ? -1 : 1) * sqrt(max(0, r5 * r5 * d22 - D2 * D2)), cx0 = (D2 * dy - dx * d4) / d22, cy0 = (-D2 * dx - dy * d4) / d22, cx1 = (D2 * dy + dx * d4) / d22, cy1 = (-D2 * dx + dy * d4) / d22, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function arc_default() {
  ...
  arc.centroid = function() {
    var r5 = (+innerRadius.apply(this, arguments) + +outerRadius.apply(this, arguments)) / 2, a7 = (+startAngle.apply(this, arguments) + +endAngle.apply(this, arguments)) / 2 - pi / 2;
    return [cos(a7) * r5, sin(a7) * r5];
  };
...
function line_default(x3, y5) {
  ...
  function line(data) {
    var i5, n6 = (data = array_default2(data)).length, d4, defined0 = false, buffer;
    if (context == null) output = curve(buffer = path2());
    for (i5 = 0; i5 <= n6; ++i5) {
      if (!(i5 < n6 && defined(d4 = data[i5], i5, data)) === defined0) {
        if (defined0 = !defined0) output.lineStart();
        else output.lineEnd();
      }
      if (defined0) output.point(+x3(d4, i5, data), +y5(d4, i5, data));
    }
...
function area_default(x0, y0, y1) {
  ...
  function area(data) {
    var i5, j4, k5, n6 = (data = array_default2(data)).length, d4, defined0 = false, buffer, x0z = new Array(n6), y0z = new Array(n6);
    if (context == null) output = curve(buffer = path2());
    for (i5 = 0; i5 <= n6; ++i5) {
      if (!(i5 < n6 && defined(d4 = data[i5], i5, data)) === defined0) {
      ...
      if (defined0) {
        x0z[i5] = +x0(d4, i5, data), y0z[i5] = +y0(d4, i5, data);
        output.point(x1 ? +x1(d4, i5, data) : x0z[i5], y1 ? +y1(d4, i5, data) : y0z[i5]);
      }
    }
    if (buffer) return output = null, buffer + "" || null;
  }
...
function descending_default(a7, b4) {
  return b4 < a7 ? -1 : b4 > a7 ? 1 : b4 >= a7 ? 0 : NaN;
}

// node_modules/d3-shape/src/identity.js
function identity_default(d4) {
  return d4;
}
...
function pie_default() {
  ...
  function pie(data) {
    var i5, n6 = (data = array_default2(data)).length, j4, k5, sum3 = 0, index2 = new Array(n6), arcs = new Array(n6), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p4 = Math.min(Math.abs(da) / n6, padAngle.apply(this, arguments)), pa = p4 * (da < 0 ? -1 : 1), v4;
    for (i5 = 0; i5 < n6; ++i5) {
      if ((v4 = arcs[index2[i5] = i5] = +value(data[i5], i5, data)) > 0) {
        sum3 += v4;
      }
    }
    ...
    for (i5 = 0, k5 = sum3 ? (da - n6 * pa) / sum3 : 0; i5 < n6; ++i5, a0 = a1) {
      j4 = index2[i5], v4 = arcs[j4], a1 = a0 + (v4 > 0 ? v4 * k5 : 0) + pa, arcs[j4] = {
        data: data[j4],
        index: i5,
        value: v4,
        startAngle: a0,
...
Radial.prototype = {
  ...
  point: function(a7, r5) {
    this._curve.point(r5 * Math.sin(a7), r5 * -Math.cos(a7));
  }
};
...
function point3(that, x3, y5) {
  ...
  if (that._l01_a > epsilon) {
    var a7 = 2 * that._l01_2a + 3 * that._l01_a * that._l12_a + that._l12_2a, n6 = 3 * that._l01_a * (that._l01_a + that._l12_a);
    x1 = (x1 * a7 - that._x0 * that._l12_2a + that._x2 * that._l01_2a) / n6;
    y1 = (y1 * a7 - that._y0 * that._l12_2a + that._y2 * that._l01_2a) / n6;
  }
  if (that._l23_a > epsilon) {
    var b4 = 2 * that._l23_2a + 3 * that._l23_a * that._l12_a + that._l12_2a, m3 = 3 * that._l23_a * (that._l23_a + that._l12_a);
    x22 = (x22 * b4 + that._x1 * that._l23_2a - x3 * that._l12_2a) / m3;
    y22 = (y22 * b4 + that._y1 * that._l23_2a - y5 * that._l12_2a) / m3;
  }
...
function controlPoints(x3) {
  var i5, n6 = x3.length - 1, m3, a7 = new Array(n6), b4 = new Array(n6), r5 = new Array(n6);
  a7[0] = 0, b4[0] = 2, r5[0] = x3[0] + 2 * x3[1];
  for (i5 = 1; i5 < n6 - 1; ++i5) a7[i5] = 1, b4[i5] = 4, r5[i5] = 4 * x3[i5] + 2 * x3[i5 + 1];
  a7[n6 - 1] = 2, b4[n6 - 1] = 7, r5[n6 - 1] = 8 * x3[n6 - 1] + x3[n6];
  for (i5 = 1; i5 < n6; ++i5) m3 = a7[i5] / b4[i5 - 1], b4[i5] -= m3, r5[i5] -= m3 * r5[i5 - 1];
  a7[n6 - 1] = r5[n6 - 1] / b4[n6 - 1];
  for (i5 = n6 - 2; i5 >= 0; --i5) a7[i5] = (r5[i5] - a7[i5 + 1]) / b4[i5];
  b4[n6 - 1] = (x3[n6] + a7[n6 - 1]) / 2;
  for (i5 = 0; i5 < n6 - 1; ++i5) b4[i5] = 2 * x3[i5 + 1] - a7[i5 + 1];
  return [a7, b4];
}
  ...
  function stack(data) {
    ...
    for (const d4 of data) {
      for (i5 = 0, ++j4; i5 < n6; ++i5) {
        (sz[i5][j4] = [0, +value(d4, sz[i5].key, j4, data)]).data = d4;
      }
    }
...
function diverging_default(series, order) {
  if (!((n6 = series.length) > 0)) return;
  for (var i5, j4 = 0, d4, dy, yp, yn2, n6, m3 = series[order[0]].length; j4 < m3; ++j4) {
    for (yp = yn2 = 0, i5 = 0; i5 < n6; ++i5) {
      if ((dy = (d4 = series[order[i5]][j4])[1] - d4[0]) > 0) {
        d4[0] = yp, d4[1] = yp += dy;
      } else if (dy < 0) {
...
function appearance_default(series) {
  ...
  return none_default2(series).sort(function(a7, b4) {
    return peaks[a7] - peaks[b4];
  });
}
...
function ascending_default(series) {
  ...
  return none_default2(series).sort(function(a7, b4) {
    return sums[a7] - sums[b4];
  });
}
function sum(series) {
  var s6 = 0, i5 = -1, n6 = series.length, v4;
  while (++i5 < n6) if (v4 = +series[i5][1]) s6 += v4;
  return s6;
}
...
function ascending(a7, b4) {
  return a7 == null || b4 == null ? NaN : a7 < b4 ? -1 : a7 > b4 ? 1 : a7 >= b4 ? 0 : NaN;
}

// node_modules/d3-scale/node_modules/d3-array/src/descending.js
function descending(a7, b4) {
  return a7 == null || b4 == null ? NaN : b4 < a7 ? -1 : b4 > a7 ? 1 : b4 >= a7 ? 0 : NaN;
}
...
function bisector(f4) {
  ...
  if (f4.length !== 2) {
    compare1 = ascending;
    compare2 = (d4, x3) => ascending(f4(d4), x3);
    delta = (d4, x3) => f4(d4) - x3;
  } else {
    compare1 = f4 === ascending || f4 === descending ? f4 : zero2;
    compare2 = f4;
    delta = f4;
  }
  function left(a7, x3, lo = 0, hi = a7.length) {
    if (lo < hi) {
      if (compare1(x3, x3) !== 0) return hi;
      do {
        const mid = lo + hi >>> 1;
        if (compare2(a7[mid], x3) < 0) lo = mid + 1;
        else hi = mid;
      } while (lo < hi);
    }
    return lo;
  }
  function right(a7, x3, lo = 0, hi = a7.length) {
    if (lo < hi) {
      if (compare1(x3, x3) !== 0) return hi;
      do {
        const mid = lo + hi >>> 1;
  ...
  function center(a7, x3, lo = 0, hi = a7.length) {
    const i5 = left(a7, x3, lo, hi - 1);
    return i5 > lo && delta(a7[i5 - 1], x3) > -delta(a7[i5], x3) ? i5 - 1 : i5;
  }
...
function ordinal() {
  ...
  function scale(d4) {
    let i5 = index2.get(d4);
    if (i5 === void 0) {
      if (unknown !== implicit) return unknown;
      index2.set(d4, i5 = domain.push(d4) - 1);
    }
...
function normalize(a7, b4) {
  return (b4 -= a7 = +a7) ? function(x3) {
    return (x3 - a7) / b4;
  } : constants(isNaN(b4) ? NaN : 0.5);
}
function clamper(a7, b4) {
  var t7;
  if (a7 > b4) t7 = a7, a7 = b4, b4 = t7;
  return function(x3) {
    return Math.max(a7, Math.min(b4, x3));
  };
}
...
function polymap(domain, range2, interpolate2) {
  var j4 = Math.min(domain.length, range2.length) - 1, d4 = new Array(j4), r5 = new Array(j4), i5 = -1;
...
function formatPrefixAuto_default(x3, p4) {
  var d4 = formatDecimalParts(x3, p4);
  if (!d4) return x3 + "";
...
function locale_default(locale3) {
  ...
  function formatPrefix2(specifier, value) {
    var f4 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e8 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k5 = Math.pow(10, -e8), prefix2 = prefixes2[8 + e8 / 3];
...
function loggish(transform) {
  ...
  scale.ticks = (count2) => {
    ...
    if (!(base % 1) && j4 - i5 < n6) {
      ...
      if (z5.length * 2 < n6) z5 = ticks(u5, v4, n6);
    } else {
  ...
  scale.tickFormat = (count2, specifier) => {
    ...
    return (d4) => {
      let i5 = d4 / pows(Math.round(logs(d4)));
      if (i5 * base < base - 0.5) i5 *= base;
      return i5 <= k5 ? specifier(d4) : "";
    };
  };
  scale.nice = () => {
...
function quantize() {
  var x0 = 0, x1 = 1, n6 = 1, domain = [0.5], range2 = [0, 1], unknown;
  function scale(x3) {
    return x3 != null && x3 <= x3 ? range2[bisect_default(domain, x3, 0, n6)] : unknown;
  }
  function rescale() {
    var i5 = -1;
    domain = new Array(n6);
    while (++i5 < n6) domain[i5] = ((i5 + 1) * x1 - (i5 - n6) * x0) / (n6 + 1);
    return scale;
  }
  scale.domain = function(_2) {
  ...
  scale.range = function(_2) {
    return arguments.length ? (n6 = (range2 = Array.from(_2)).length - 1, rescale()) : range2.slice();
  };
  scale.invertExtent = function(y5) {
    var i5 = range2.indexOf(y5);
    return i5 < 0 ? [NaN, NaN] : i5 < 1 ? [x0, domain[0]] : i5 >= n6 ? [domain[n6 - 1], x1] : [domain[i5 - 1], domain[i5]];
  };
  scale.unknown = function(_2) {
...
function timeInterval(floori, offseti, count2, field) {
  ...
  if (count2) {
    ...
    interval.every = (step) => {
      ...
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval : interval.filter(field ? (d4) => field(d4) % step === 0 : (d4) => interval.count(0, d4) % step === 0);
    };
  }
  return interval;
}
...
function newDate(y5, m3, d4) {
  return { y: y5, m: m3, d: d4, H: 0, M: 0, S: 0, L: 0 };
}
  ...
  function parseSpecifier(d4, specifier, string, j4) {
    ...
    while (i5 < n6) {
      ...
      if (c10 === 37) {
        ...
        if (!parse || (j4 = parse(d4, string, j4)) < 0) return -1;
...
function formatDayOfMonth(d4, p4) {
  return pad(d4.getDate(), p4, 2);
}
function formatHour24(d4, p4) {
  return pad(d4.getHours(), p4, 2);
}
function formatHour12(d4, p4) {
  return pad(d4.getHours() % 12 || 12, p4, 2);
}
function formatDayOfYear(d4, p4) {
  return pad(1 + day_default.count(year_default(d4), d4), p4, 3);
}
function formatMilliseconds(d4, p4) {
  return pad(d4.getMilliseconds(), p4, 3);
}
function formatMicroseconds(d4, p4) {
  return formatMilliseconds(d4, p4) + "000";
}
function formatMonthNumber(d4, p4) {
  return pad(d4.getMonth() + 1, p4, 2);
}
function formatMinutes(d4, p4) {
  return pad(d4.getMinutes(), p4, 2);
}
function formatSeconds(d4, p4) {
  return pad(d4.getSeconds(), p4, 2);
}
function formatWeekdayNumberMonday(d4) {
  var day2 = d4.getDay();
  return day2 === 0 ? 7 : day2;
}
function formatWeekNumberSunday(d4, p4) {
  return pad(sunday.count(year_default(d4) - 1, d4), p4, 2);
}
function dISO(d4) {
  var day2 = d4.getDay();
  return day2 >= 4 || day2 === 0 ? thursday(d4) : thursday.ceil(d4);
}
function formatWeekNumberISO(d4, p4) {
  d4 = dISO(d4);
  return pad(thursday.count(year_default(d4), d4) + (year_default(d4).getDay() === 4), p4, 2);
}
function formatWeekdayNumberSunday(d4) {
  return d4.getDay();
}
function formatWeekNumberMonday(d4, p4) {
  return pad(monday.count(year_default(d4) - 1, d4), p4, 2);
}
function formatYear(d4, p4) {
  return pad(d4.getFullYear() % 100, p4, 2);
}
function formatYearISO(d4, p4) {
  d4 = dISO(d4);
  return pad(d4.getFullYear() % 100, p4, 2);
}
function formatFullYear(d4, p4) {
  return pad(d4.getFullYear() % 1e4, p4, 4);
}
function formatFullYearISO(d4, p4) {
  var day2 = d4.getDay();
  d4 = day2 >= 4 || day2 === 0 ? thursday(d4) : thursday.ceil(d4);
  return pad(d4.getFullYear() % 1e4, p4, 4);
}
function formatZone(d4) {
  var z5 = d4.getTimezoneOffset();
  return (z5 > 0 ? "-" : (z5 *= -1, "+")) + pad(z5 / 60 | 0, "0", 2) + pad(z5 % 60, "0", 2);
}
function formatUTCDayOfMonth(d4, p4) {
  return pad(d4.getUTCDate(), p4, 2);
}
function formatUTCHour24(d4, p4) {
  return pad(d4.getUTCHours(), p4, 2);
}
function formatUTCHour12(d4, p4) {
  return pad(d4.getUTCHours() % 12 || 12, p4, 2);
}
function formatUTCDayOfYear(d4, p4) {
  return pad(1 + utcDay_default.count(utcYear_default(d4), d4), p4, 3);
}
function formatUTCMilliseconds(d4, p4) {
  return pad(d4.getUTCMilliseconds(), p4, 3);
}
function formatUTCMicroseconds(d4, p4) {
  return formatUTCMilliseconds(d4, p4) + "000";
}
function formatUTCMonthNumber(d4, p4) {
  return pad(d4.getUTCMonth() + 1, p4, 2);
}
function formatUTCMinutes(d4, p4) {
  return pad(d4.getUTCMinutes(), p4, 2);
}
function formatUTCSeconds(d4, p4) {
  return pad(d4.getUTCSeconds(), p4, 2);
}
function formatUTCWeekdayNumberMonday(d4) {
  var dow = d4.getUTCDay();
  return dow === 0 ? 7 : dow;
}
function formatUTCWeekNumberSunday(d4, p4) {
  return pad(utcSunday2.count(utcYear_default(d4) - 1, d4), p4, 2);
}
function UTCdISO(d4) {
  var day2 = d4.getUTCDay();
  return day2 >= 4 || day2 === 0 ? utcThursday2(d4) : utcThursday2.ceil(d4);
}
function formatUTCWeekNumberISO(d4, p4) {
  d4 = UTCdISO(d4);
  return pad(utcThursday2.count(utcYear_default(d4), d4) + (utcYear_default(d4).getUTCDay() === 4), p4, 2);
}
function formatUTCWeekdayNumberSunday(d4) {
  return d4.getUTCDay();
}
function formatUTCWeekNumberMonday(d4, p4) {
  return pad(utcMonday2.count(utcYear_default(d4) - 1, d4), p4, 2);
}
function formatUTCYear(d4, p4) {
  return pad(d4.getUTCFullYear() % 100, p4, 2);
}
function formatUTCYearISO(d4, p4) {
  d4 = UTCdISO(d4);
  return pad(d4.getUTCFullYear() % 100, p4, 2);
}
function formatUTCFullYear(d4, p4) {
  return pad(d4.getUTCFullYear() % 1e4, p4, 4);
}
function formatUTCFullYearISO(d4, p4) {
  var day2 = d4.getUTCDay();
  d4 = day2 >= 4 || day2 === 0 ? utcThursday2(d4) : utcThursday2.ceil(d4);
  return pad(d4.getUTCFullYear() % 1e4, p4, 4);
}
...
function calendar(ticks2, tickInterval, year2, month2, week, day2, hour2, minute2, second3, format2) {
  ...
  scale.ticks = function(interval) {
    var d4 = domain();
    return ticks2(d4[0], d4[d4.length - 1], interval == null ? 10 : interval);
  };
  scale.tickFormat = function(count2, specifier) {
  ...
  scale.nice = function(interval) {
    var d4 = domain();
    if (!interval || typeof interval.range !== "function") interval = tickInterval(d4[0], d4[d4.length - 1], interval == null ? 10 : interval);
    return interval ? domain(nice2(d4, interval)) : scale;
  };
  scale.copy = function() {
...
var qr = function(e8) {
  var t7 = e8.children, n6 = e8.animate, o5 = void 0 === n6 || n6, i5 = e8.config, a7 = void 0 === i5 ? "default" : i5, l5 = (0, import_react18.useMemo)(function() {
    var e9 = (0, import_isString.default)(a7) ? config[a7] : a7;
...
var Fr = function(e8) {
  var r5 = e8.children, t7 = e8.theme, n6 = e8.renderWrapper, i5 = void 0 === n6 || n6, a7 = e8.isInteractive, l5 = void 0 === a7 || a7, d4 = e8.animate, u5 = e8.motionConfig, c10 = (0, import_react18.useRef)(null);
  return (0, import_jsx_runtime2.jsx)(j, { theme: t7, children: (0, import_jsx_runtime2.jsx)(qr, { animate: d4, config: u5, children: (0, import_jsx_runtime2.jsx)(W2, { container: c10, children: (0, import_jsx_runtime2.jsxs)(Er, { condition: i5, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: Ur, ref: c10 }), children: [r5, l5 && (0, import_jsx_runtime2.jsx)(M, {})] }) }) }) });
};
var Kr = function(e8, r5) {
  return e8.width === r5.width && e8.height === r5.height;
};
var Nr = function(e8) {
  var r5 = e8.children, t7 = e8.width, n6 = e8.height, o5 = e8.onResize, i5 = e8.debounceResize, l5 = a2({ width: t7, height: n6 }, i5, { equalityFn: Kr })[0];
  return (0, import_react18.useEffect)(function() {
    null == o5 || o5(l5);
  }, [l5, o5]), (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: r5(l5) });
};
var $r = function(e8) {
  var r5 = e8.children, t7 = e8.defaultWidth, n6 = e8.defaultHeight, o5 = e8.onResize, i5 = e8.debounceResize, a7 = void 0 === i5 ? 0 : i5;
  return (0, import_jsx_runtime2.jsx)(AutoSizer, { defaultWidth: t7, defaultHeight: n6, children: function(e9) {
    ...
    return (0, import_jsx_runtime2.jsx)(Nr, { width: t8, height: n7, onResize: o5, debounceResize: a7, children: r5 });
  } });
};
function Jr(e8, r5) {
...
function et(e8, r5) {
  return et = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e9, r6) {
...
var at = (0, import_react18.memo)(function(e8) {
  var r5 = e8.id, t7 = e8.background, n6 = void 0 === t7 ? it.background : t7, o5 = e8.color, i5 = void 0 === o5 ? it.color : o5, a7 = e8.size, l5 = void 0 === a7 ? it.size : a7, d4 = e8.padding, u5 = void 0 === d4 ? it.padding : d4, c10 = e8.stagger, s6 = void 0 === c10 ? it.stagger : c10, f4 = l5 + u5, h2 = l5 / 2, p4 = u5 / 2;
  return true === s6 && (f4 = 2 * l5 + 2 * u5), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: f4, height: f4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f4, height: f4, fill: n6 }), (0, import_jsx_runtime2.jsx)("circle", { cx: p4 + h2, cy: p4 + h2, r: h2, fill: i5 }), s6 && (0, import_jsx_runtime2.jsx)("circle", { cx: 1.5 * u5 + l5 + h2, cy: 1.5 * u5 + l5 + h2, r: h2, fill: i5 })] });
});
var dt = 2 * Math.PI;
var ut = function(e8) {
...
var vt = (0, import_react18.memo)(function(e8) {
  var r5 = e8.id, t7 = e8.spacing, n6 = void 0 === t7 ? mt.spacing : t7, o5 = e8.rotation, i5 = void 0 === o5 ? mt.rotation : o5, a7 = e8.background, l5 = void 0 === a7 ? mt.background : a7, d4 = e8.color, u5 = void 0 === d4 ? mt.color : d4, c10 = e8.lineWidth, s6 = void 0 === c10 ? mt.lineWidth : c10, f4 = Math.round(i5) % 360, h2 = Math.abs(n6);
  f4 > 180 ? f4 -= 360 : f4 > 90 ? f4 -= 180 : f4 < -180 ? f4 += 360 : f4 < -90 && (f4 += 180);
  var p4, g2 = h2, b4 = h2;
  return 0 === f4 ? p4 = "\n                M 0 0 L " + g2 + " 0\n                M 0 " + b4 + " L " + g2 + " " + b4 + "\n            " : 90 === f4 ? p4 = "\n                M 0 0 L 0 " + b4 + "\n                M " + g2 + " 0 L " + g2 + " " + b4 + "\n            " : (g2 = Math.abs(h2 / Math.sin(ut(f4))), b4 = h2 / Math.sin(ut(90 - f4)), p4 = f4 > 0 ? "\n                    M 0 " + -b4 + " L " + 2 * g2 + " " + b4 + "\n                    M " + -g2 + " " + -b4 + " L " + g2 + " " + b4 + "\n                    M " + -g2 + " 0 L " + g2 + " " + 2 * b4 + "\n                " : "\n                    M " + -g2 + " " + b4 + " L " + g2 + " " + -b4 + "\n                    M " + -g2 + " " + 2 * b4 + " L " + 2 * g2 + " " + -b4 + "\n                    M 0 " + 2 * b4 + " L " + 2 * g2 + " 0\n                "), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: g2, height: b4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: g2, height: b4, fill: l5, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime2.jsx)("path", { d: p4, strokeWidth: s6, stroke: u5, strokeLinecap: "square" })] });
});
var _t = { color: "#000000", background: "#ffffff", size: 4, padding: 4, stagger: false };
var wt = (0, import_react18.memo)(function(e8) {
  var r5 = e8.id, t7 = e8.color, n6 = void 0 === t7 ? _t.color : t7, o5 = e8.background, i5 = void 0 === o5 ? _t.background : o5, a7 = e8.size, l5 = void 0 === a7 ? _t.size : a7, d4 = e8.padding, u5 = void 0 === d4 ? _t.padding : d4, c10 = e8.stagger, s6 = void 0 === c10 ? _t.stagger : c10, f4 = l5 + u5, h2 = u5 / 2;
  return true === s6 && (f4 = 2 * l5 + 2 * u5), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: f4, height: f4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f4, height: f4, fill: i5 }), (0, import_jsx_runtime2.jsx)("rect", { x: h2, y: h2, width: l5, height: l5, fill: n6 }), s6 && (0, import_jsx_runtime2.jsx)("rect", { x: 1.5 * u5 + l5, y: 1.5 * u5 + l5, width: l5, height: l5, fill: n6 })] });
});
...
var Rt = (0, import_react18.forwardRef)(function(e8, r5) {
  var t7 = e8.width, n6 = e8.height, o5 = e8.margin, i5 = e8.defs, a7 = e8.children, l5 = e8.role, d4 = e8.ariaLabel, u5 = e8.ariaLabelledBy, c10 = e8.ariaDescribedBy, s6 = e8.isFocusable, f4 = z();
  return (0, import_jsx_runtime2.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: t7, height: n6, role: l5, "aria-label": d4, "aria-labelledby": u5, "aria-describedby": c10, focusable: s6, tabIndex: s6 ? 0 : void 0, ref: r5, children: [(0, import_jsx_runtime2.jsx)(Mt, { defs: i5 }), (0, import_jsx_runtime2.jsx)("rect", { width: t7, height: n6, fill: f4.background }), (0, import_jsx_runtime2.jsx)("g", { transform: "translate(" + o5.left + "," + o5.top + ")", children: a7 })] });
});
...
var Ct = (0, import_react18.memo)(function(e8) {
  var r5 = e8.x, t7 = e8.y, n6 = e8.symbol, o5 = void 0 === n6 ? jt : n6, a7 = e8.size, l5 = e8.datum, u5 = e8.color, c10 = e8.borderWidth, s6 = e8.borderColor, f4 = e8.label, h2 = e8.labelTextAnchor, p4 = void 0 === h2 ? "middle" : h2, g2 = e8.labelYOffset, b4 = void 0 === g2 ? -12 : g2, m3 = e8.ariaLabel, _2 = e8.ariaLabelledBy, w3 = e8.ariaDescribedBy, O4 = e8.ariaHidden, R2 = e8.ariaDisabled, j4 = e8.isFocusable, C5 = void 0 !== j4 && j4, B3 = e8.tabIndex, P4 = void 0 === B3 ? 0 : B3, W3 = e8.onFocus, G = e8.onBlur, I = e8.testId, A4 = z(), L2 = Dr(), S3 = L2.animate, Y = L2.config, q = useSpring({ transform: "translate(" + r5 + ", " + t7 + ")", config: Y, immediate: !S3 }), D2 = (0, import_react18.useCallback)(function(e9) {
    null == W3 || W3(l5, e9);
  }, [W3, l5]), E4 = (0, import_react18.useCallback)(function(e9) {
    null == G || G(l5, e9);
  }, [G, l5]);
  return (0, import_jsx_runtime2.jsxs)(animated.g, { transform: q.transform, style: { pointerEvents: "none" }, focusable: C5, tabIndex: C5 ? P4 : void 0, "aria-label": m3, "aria-labelledby": _2, "aria-describedby": w3, "aria-disabled": R2, "aria-hidden": O4, onFocus: C5 && W3 ? D2 : void 0, onBlur: C5 && G ? E4 : void 0, "data-testid": I, children: [(0, import_react18.createElement)(o5, { size: a7, color: u5, datum: l5, borderWidth: c10, borderColor: s6 }), f4 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p4, y: b4, style: m(A4.dots.text), children: f4 })] });
});
var Bt = (0, import_react18.memo)(function(e8) {
  var r5 = e8.width, t7 = e8.height, n6 = e8.axis, o5 = e8.scale, i5 = e8.value, a7 = e8.lineStyle, l5 = e8.textStyle, d4 = e8.legend, u5 = e8.legendNode, c10 = e8.legendPosition, s6 = void 0 === c10 ? "top-right" : c10, f4 = e8.legendOffsetX, h2 = void 0 === f4 ? 14 : f4, p4 = e8.legendOffsetY, g2 = void 0 === p4 ? 14 : p4, b4 = e8.legendOrientation, m3 = void 0 === b4 ? "horizontal" : b4, y5 = z(), _2 = 0, w3 = 0, k5 = 0, x3 = 0;
  if ("y" === n6 ? (k5 = o5(i5), w3 = r5) : (_2 = o5(i5), x3 = t7), d4 && !u5) {
    var O4 = function(e9) {
      var r6 = e9.axis, t8 = e9.width, n7 = e9.height, o6 = e9.position, i6 = e9.offsetX, a8 = e9.offsetY, l6 = e9.orientation, d5 = 0, u6 = 0, c11 = "vertical" === l6 ? -90 : 0, s7 = "start";
      if ("x" === r6) switch (o6) {
        case "top-left":
          d5 = -i6, u6 = a8, s7 = "end";
          break;
        case "top":
          u6 = -a8, s7 = "horizontal" === l6 ? "middle" : "start";
          break;
        case "top-right":
          d5 = i6, u6 = a8, s7 = "horizontal" === l6 ? "start" : "end";
          break;
        case "right":
          d5 = i6, u6 = n7 / 2, s7 = "horizontal" === l6 ? "start" : "middle";
          break;
        case "bottom-right":
          d5 = i6, u6 = n7 - a8, s7 = "start";
          break;
        case "bottom":
          u6 = n7 + a8, s7 = "horizontal" === l6 ? "middle" : "end";
          break;
        case "bottom-left":
          u6 = n7 - a8, d5 = -i6, s7 = "horizontal" === l6 ? "end" : "start";
          break;
        case "left":
          d5 = -i6, u6 = n7 / 2, s7 = "horizontal" === l6 ? "end" : "middle";
      }
      else switch (o6) {
        case "top-left":
          d5 = i6, u6 = -a8, s7 = "start";
          break;
        case "top":
          d5 = t8 / 2, u6 = -a8, s7 = "horizontal" === l6 ? "middle" : "start";
          break;
        case "top-right":
          d5 = t8 - i6, u6 = -a8, s7 = "horizontal" === l6 ? "end" : "start";
          break;
        case "right":
          d5 = t8 + i6, s7 = "horizontal" === l6 ? "start" : "middle";
          break;
        case "bottom-right":
          d5 = t8 - i6, u6 = a8, s7 = "end";
          break;
        case "bottom":
          d5 = t8 / 2, u6 = a8, s7 = "horizontal" === l6 ? "middle" : "end";
          break;
        case "bottom-left":
          d5 = i6, u6 = a8, s7 = "horizontal" === l6 ? "start" : "end";
          break;
        case "left":
          d5 = -i6, s7 = "horizontal" === l6 ? "end" : "middle";
      }
      return { x: d5, y: u6, rotation: c11, textAnchor: s7 };
    }({ axis: n6, width: r5, height: t7, position: s6, offsetX: h2, offsetY: g2, orientation: m3 });
    u5 = (0, import_jsx_runtime2.jsx)("text", { transform: "translate(" + O4.x + ", " + O4.y + ") rotate(" + O4.rotation + ")", textAnchor: O4.textAnchor, dominantBaseline: "central", style: l5, children: d4 });
  }
  return (0, import_jsx_runtime2.jsxs)("g", { transform: "translate(" + _2 + ", " + k5 + ")", children: [(0, import_jsx_runtime2.jsx)("line", { x1: 0, x2: w3, y1: 0, y2: x3, stroke: y5.markers.lineColor, strokeWidth: y5.markers.lineStrokeWidth, style: a7 }), u5] });
});
...
var Wt = ["theme", "renderWrapper", "animate", "motionConfig"];
var Gt = function(e8) {
  return function(r5) {
    function t7() {
    ...
    var n6, o5;
    return o5 = r5, (n6 = t7).prototype = Object.create(o5.prototype), n6.prototype.constructor = n6, et(n6, o5), t7.prototype.render = function() {
      var r6 = this.props, t8 = r6.theme, n7 = r6.renderWrapper, o6 = r6.animate, i5 = r6.motionConfig, a7 = Zr(r6, Wt);
      return (0, import_jsx_runtime2.jsx)(Fr, { theme: t8, renderWrapper: n7, isInteractive: a7.isInteractive, animate: o6, motionConfig: i5, children: (0, import_jsx_runtime2.jsx)(e8, Vr({}, a7)) });
    }, t7;
...
var It = function(e8) {
  ...
  }(e8), d4 = (0, import_react18.useMemo)(function() {
...
var Vt = function(e8) {
  if ((0, import_isFunction.default)(e8)) {
    if (!(0, import_isFunction.default)(e8.domain)) throw new Error("Provided colors should be a valid quantize scale providing a 'domain()' function");
    return e8;
  }
  if (Jt[e8]) return quantize().range(Jt[e8]);
  if ((0, import_isArray.default)(e8)) return quantize().range(e8);
  throw new Error("Unable to guess quantize color scale from '" + e8 + "',\nmust be a function or one of:\n'" + Qt.join("', '") + "'");
};
...
var kn = function(e8, r5) {
  var t7, n6 = "touches" in r5 ? r5.touches[0] : r5, o5 = n6.clientX, i5 = n6.clientY, a7 = e8.getBoundingClientRect(), l5 = (t7 = void 0 !== e8.getBBox ? e8.getBBox() : { width: e8.offsetWidth || 0, height: e8.offsetHeight || 0 }).width === a7.width ? 1 : t7.width / a7.width;
  return [(o5 - a7.left) * l5, (i5 - a7.top) * l5];
};
...
var Mn = function(e8, r5, t7, n6) {
  var o5 = void 0 === n6 ? {} : n6, i5 = o5.dataKey, a7 = o5.colorKey, l5 = void 0 === a7 ? "color" : a7, d4 = o5.targetKey, u5 = void 0 === d4 ? "fill" : d4, c10 = [], s6 = {};
  return e8.length && r5.length && (c10 = [].concat(e8), r5.forEach(function(r6) {
    for (var n7, o6 = function() {
      var t8 = n7.value, o7 = t8.id, a9 = t8.match;
      if (zn(a9, r6, i5)) {
        var d5 = e8.find(function(e9) {
          return e9.id === o7;
        });
        if (d5) {
          if (On.includes(d5.type)) if ("inherit" === d5.background || "inherit" === d5.color) {
            var f4 = (0, import_get2.default)(r6, l5), h2 = d5.background, p4 = d5.color, g2 = o7;
            "inherit" === d5.background && (g2 = g2 + ".bg." + f4, h2 = f4), "inherit" === d5.color && (g2 = g2 + ".fg." + f4, p4 = f4), (0, import_set2.default)(r6, u5, "url(#" + g2 + ")"), s6[g2] || (c10.push(Vr({}, d5, { id: g2, background: h2, color: p4 })), s6[g2] = 1);
          } else (0, import_set2.default)(r6, u5, "url(#" + o7 + ")");
          else if (xn.includes(d5.type)) {
            if (d5.colors.map(function(e9) {
              return e9.color;
            }).includes("inherit")) {
              var b4 = (0, import_get2.default)(r6, l5), m3 = o7, v4 = Vr({}, d5, { colors: d5.colors.map(function(e9, r7) {
                return "inherit" !== e9.color ? e9 : (m3 = m3 + "." + r7 + "." + b4, Vr({}, e9, { color: "inherit" === e9.color ? b4 : e9.color }));
              }) });
              v4.id = m3, (0, import_set2.default)(r6, u5, "url(#" + m3 + ")"), s6[m3] || (c10.push(v4), s6[m3] = 1);
            } else (0, import_set2.default)(r6, u5, "url(#" + o7 + ")");
          }
        }
        return 1;
      }
    }, a8 = Qr(t7); !(n7 = a8()).done && !o6(); ) ;
  })), c10;
};
function Rn() {
...
function v2() {
  return v2 = Object.assign ? Object.assign.bind() : function(t7) {
...
var m2 = { pointerEvents: "none", position: "absolute", zIndex: 10, top: 0, left: 0 };
var b2 = function(t7, i5) {
  return "translate(" + t7 + "px, " + i5 + "px)";
};
var g = (0, import_react19.memo)(function(t7) {
  var n6, o5 = t7.position, r5 = t7.anchor, e8 = t7.children, l5 = z(), u5 = Dr(), y5 = u5.animate, f4 = u5.config, g2 = sn(), w3 = g2[0], T2 = g2[1], C5 = (0, import_react19.useRef)(false), E4 = void 0, P4 = false, V2 = T2.width > 0 && T2.height > 0, O4 = Math.round(o5[0]), N2 = Math.round(o5[1]);
  V2 && ("top" === r5 ? (O4 -= T2.width / 2, N2 -= T2.height + 14) : "right" === r5 ? (O4 += 14, N2 -= T2.height / 2) : "bottom" === r5 ? (O4 -= T2.width / 2, N2 += 14) : "left" === r5 ? (O4 -= T2.width + 14, N2 -= T2.height / 2) : "center" === r5 && (O4 -= T2.width / 2, N2 -= T2.height / 2), E4 = { transform: b2(O4, N2) }, C5.current || (P4 = true), C5.current = [O4, N2]);
  var j4 = useSpring({ to: E4, config: f4, immediate: !y5 || P4 }), k5 = l5.tooltip;
  ...
  var z5 = function(t8, i5) {
    ...
    return n7;
  }(k5, x2), A4 = v2({}, m2, z5, { transform: null != (n6 = j4.transform) ? n6 : b2(O4, N2), opacity: j4.transform ? 1 : 0 });
...
var w2 = (0, import_react19.memo)(function(t7) {
  ...
  return (0, import_jsx_runtime3.jsx)("span", { style: v2({ display: "block", width: n6, height: n6, background: o5 }, void 0 === r5 ? {} : r5) });
});
var T = (0, import_react19.memo)(function(t7) {
  var i5, n6 = t7.id, o5 = t7.value, r5 = t7.format, e8 = t7.enableChip, l5 = void 0 !== e8 && e8, a7 = t7.color, c10 = t7.renderContent, s6 = z(), h2 = hn(r5);
  if ("function" == typeof c10) i5 = c10();
  else {
    var f4 = o5;
    void 0 !== h2 && void 0 !== f4 && (f4 = h2(f4)), i5 = (0, import_jsx_runtime3.jsxs)("div", { style: s6.tooltip.basic, children: [l5 && (0, import_jsx_runtime3.jsx)(w2, { color: a7, style: s6.tooltip.chip }), void 0 !== f4 ? (0, import_jsx_runtime3.jsxs)("span", { children: [n6, ": ", (0, import_jsx_runtime3.jsx)("strong", { children: "" + f4 })] }) : n6] });
  }
...
var E2 = (0, import_react19.memo)(function(t7) {
  var i5, n6 = t7.title, o5 = t7.rows, r5 = void 0 === o5 ? [] : o5, e8 = t7.renderContent, l5 = z();
  return r5.length ? (i5 = "function" == typeof e8 ? e8() : (0, import_jsx_runtime3.jsxs)("div", { children: [n6 && n6, (0, import_jsx_runtime3.jsx)("table", { style: v2({}, C3, l5.tooltip.table), children: (0, import_jsx_runtime3.jsx)("tbody", { children: r5.map(function(t8, i6) {
...
var P2 = (0, import_react19.memo)(function(t7) {
  var i5 = t7.x0, o5 = t7.x1, r5 = t7.y0, e8 = t7.y1, l5 = z(), h2 = Dr(), u5 = h2.animate, y5 = h2.config, f4 = (0, import_react19.useMemo)(function() {
    return v2({}, l5.crosshair.line, { pointerEvents: "none" });
  }, [l5.crosshair.line]), x3 = useSpring({ x1: i5, x2: o5, y1: r5, y2: e8, config: y5, immediate: !u5 });
  return (0, import_jsx_runtime3.jsx)(animated.line, v2({}, x3, { fill: "none", style: f4 }));
});
P2.displayName = "CrosshairLine";
var V = (0, import_react19.memo)(function(t7) {
  var i5, n6, o5 = t7.width, r5 = t7.height, e8 = t7.type, l5 = t7.x, a7 = t7.y;
  return "cross" === e8 ? (i5 = { x0: l5, x1: l5, y0: 0, y1: r5 }, n6 = { x0: 0, x1: o5, y0: a7, y1: a7 }) : "top-left" === e8 ? (i5 = { x0: l5, x1: l5, y0: 0, y1: a7 }, n6 = { x0: 0, x1: l5, y0: a7, y1: a7 }) : "top" === e8 ? i5 = { x0: l5, x1: l5, y0: 0, y1: a7 } : "top-right" === e8 ? (i5 = { x0: l5, x1: l5, y0: 0, y1: a7 }, n6 = { x0: l5, x1: o5, y0: a7, y1: a7 }) : "right" === e8 ? n6 = { x0: l5, x1: o5, y0: a7, y1: a7 } : "bottom-right" === e8 ? (i5 = { x0: l5, x1: l5, y0: a7, y1: r5 }, n6 = { x0: l5, x1: o5, y0: a7, y1: a7 }) : "bottom" === e8 ? i5 = { x0: l5, x1: l5, y0: a7, y1: r5 } : "bottom-left" === e8 ? (i5 = { x0: l5, x1: l5, y0: a7, y1: r5 }, n6 = { x0: 0, x1: l5, y0: a7, y1: a7 }) : "left" === e8 ? n6 = { x0: 0, x1: l5, y0: a7, y1: a7 } : "x" === e8 ? i5 = { x0: l5, x1: l5, y0: 0, y1: r5 } : "y" === e8 && (n6 = { x0: 0, x1: o5, y0: a7, y1: a7 }), (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [i5 && (0, import_jsx_runtime3.jsx)(P2, { x0: i5.x0, x1: i5.x1, y0: i5.y0, y1: i5.y1 }), n6 && (0, import_jsx_runtime3.jsx)(P2, { x0: n6.x0, x1: n6.x1, y0: n6.y0, y1: n6.y1 })] });
});
...
var k3 = function(t7) {
  var i5 = (0, import_react19.useState)(N), o5 = i5[0], l5 = i5[1], a7 = (0, import_react19.useCallback)(function(t8, i6, n6) {
    var o6 = i6[0], r5 = i6[1];
    ...
    void 0 === o6 && (o6 = "top");
    var r5 = t7.current.getBoundingClientRect(), e8 = t7.current.offsetWidth, a8 = e8 === r5.width ? 1 : e8 / r5.width, c11 = "touches" in n6 ? n6.touches[0] : n6, s7 = c11.clientX, h2 = c11.clientY, u5 = (s7 - r5.left) * a8, d4 = (h2 - r5.top) * a8;
    "left" !== o6 && "right" !== o6 || (o6 = u5 < r5.width / 2 ? "right" : "left"), l5({ isVisible: true, position: [u5, d4], anchor: o6, content: i6 });
  }, [t7, l5]), s6 = (0, import_react19.useCallback)(function() {
    l5(N);
  }, [l5]);
  return { actions: (0, import_react19.useMemo)(function() {
    return { showTooltipAt: a7, showTooltipFromEvent: c10, hideTooltip: s6 };
  }, [a7, c10, s6]), state: o5 };
};
var z3 = function() {
...
var W2 = function(t7) {
  var i5 = t7.container, n6 = t7.children, o5 = k3(i5), r5 = o5.actions, e8 = o5.state;
...
function a5() {
  return a5 = Object.assign ? Object.assign.bind() : function(t7) {
    for (var e8 = 1; e8 < arguments.length; e8++) {
      var o5 = arguments[e8];
      for (var n6 in o5) ({}).hasOwnProperty.call(o5, n6) && (t7[n6] = o5[n6]);
    }
    return t7;
  }, a5.apply(null, arguments);
}
function h(t7, e8) {
  if (null == t7) return {};
  var o5 = {};
...
var p2 = ["style", "children"];
var s4 = ["outlineWidth", "outlineColor", "outlineOpacity"];
var d2 = function(r5) {
  var i5 = r5.style, l5 = r5.children, c10 = h(r5, p2), f4 = i5.outlineWidth, u5 = i5.outlineColor, d4 = i5.outlineOpacity, m3 = h(i5, s4);
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [f4 > 0 && (0, import_jsx_runtime4.jsx)(animated.text, a5({}, c10, { style: a5({}, m3, { strokeWidth: 2 * f4, stroke: u5, strokeOpacity: d4, strokeLinejoin: "round" }), children: l5 })), (0, import_jsx_runtime4.jsx)(animated.text, a5({}, c10, { style: m3, children: l5 }))] });
};
...
var Ve = { nivo: ["#e8c1a0", "#f47560", "#f1e15b", "#e8a838", "#61cdbb", "#97e3d5"], category10: category10_default, accent: Accent_default, dark2: Dark2_default, paired: Paired_default, pastel1: Pastel1_default, pastel2: Pastel2_default, set1: Set1_default, set2: Set2_default, set3: Set3_default, tableau10: Tableau10_default };
var qe = Object.keys(Ve);
  ...
  if ((0, import_isPlainObject2.default)(e8)) {
    ...
    if (We(e8)) {
      ...
      if (Array.isArray(e8.modifiers)) {
        ...
        }, l5 = Ce(e8.modifiers); !(o5 = l5()).done; ) u5();
  ...
  if ((0, import_isPlainObject2.default)(e8)) {
    ...
    if (function(e9) {
      ...
      if (He(e8.scheme)) {
        ...
        var l5 = ordinal($e[e8.scheme][e8.size || 11]), a7 = function(e9) {
          return l5(n6(e9));
        };
        return a7.scale = l5, a7;
      }
      if (Je(e8.scheme)) {
...
var v3 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l5 = e8.opacity, a7 = void 0 === l5 ? 1 : l5, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d4 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("circle", { r: o5 / 2, cx: i5 + o5 / 2, cy: n6 + o5 / 2, fill: r5, opacity: a7, strokeWidth: s6, stroke: void 0 === d4 ? "transparent" : d4, style: { pointerEvents: "none" } });
};
var u4 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l5 = e8.opacity, a7 = void 0 === l5 ? 1 : l5, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d4 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + i5 + "," + n6 + ")", children: (0, import_jsx_runtime5.jsx)("path", { d: "\n                    M" + o5 / 2 + " 0\n                    L" + 0.8 * o5 + " " + o5 / 2 + "\n                    L" + o5 / 2 + " " + o5 + "\n                    L" + 0.2 * o5 + " " + o5 / 2 + "\n                    L" + o5 / 2 + " 0\n                ", fill: r5, opacity: a7, strokeWidth: s6, stroke: void 0 === d4 ? "transparent" : d4, style: { pointerEvents: "none" } }) });
};
var p3 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l5 = e8.opacity, a7 = void 0 === l5 ? 1 : l5, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d4 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("rect", { x: i5, y: n6, fill: r5, opacity: a7, strokeWidth: s6, stroke: void 0 === d4 ? "transparent" : d4, width: o5, height: o5, style: { pointerEvents: "none" } });
};
var y4 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l5 = e8.opacity, a7 = void 0 === l5 ? 1 : l5, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d4 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + i5 + "," + n6 + ")", children: (0, import_jsx_runtime5.jsx)("path", { d: "\n                M" + o5 / 2 + " 0\n                L" + o5 + " " + o5 + "\n                L0 " + o5 + "\n                L" + o5 / 2 + " 0\n            ", fill: r5, opacity: a7, strokeWidth: s6, stroke: void 0 === d4 ? "transparent" : d4, style: { pointerEvents: "none" } }) });
...
function b3() {
  return b3 = Object.assign ? Object.assign.bind() : function(t7) {
    for (var e8 = 1; e8 < arguments.length; e8++) {
      var i5 = arguments[e8];
      for (var n6 in i5) ({}).hasOwnProperty.call(i5, n6) && (t7[n6] = i5[n6]);
    }
...
var k4 = { translateX: 0, translateY: 0, padding: 0, itemsSpacing: 0, itemDirection: "left-to-right", justify: false, symbolShape: "square", symbolSize: 16, symbolSpacing: 8 };
var S2 = { top: 0, right: 0, bottom: 0, left: 0 };
var A3 = function(t7) {
  var e8, i5 = t7.direction, n6 = t7.itemsSpacing, o5 = t7.padding, r5 = t7.itemCount, l5 = t7.itemWidth, a7 = t7.itemHeight;
  ...
  var c10 = "number" == typeof o5 ? { top: o5, right: o5, bottom: o5, left: o5 } : b3({}, S2, o5), s6 = c10.left + c10.right, d4 = c10.top + c10.bottom, h2 = l5 + s6, g2 = a7 + d4, m3 = (r5 - 1) * n6;
  return "row" === i5 ? h2 = l5 * r5 + m3 + s6 : "column" === i5 && (g2 = a7 * r5 + m3 + d4), { width: h2, height: g2, padding: c10 };
};
var C4 = function(t7) {
  var e8 = t7.anchor, i5 = t7.translateX, n6 = t7.translateY, o5 = t7.containerWidth, r5 = t7.containerHeight, l5 = t7.width, a7 = t7.height, c10 = i5, s6 = n6;
  switch (e8) {
    case "top":
      c10 += (o5 - l5) / 2;
      break;
    case "top-right":
      ...
      break;
    case "right":
      c10 += o5 - l5, s6 += (r5 - a7) / 2;
      break;
    case "bottom-right":
      c10 += o5 - l5, s6 += r5 - a7;
      break;
    case "bottom":
      c10 += (o5 - l5) / 2, s6 += r5 - a7;
      break;
    case "bottom-left":
      s6 += r5 - a7;
      break;
    case "left":
      ...
      break;
    case "center":
      c10 += (o5 - l5) / 2, s6 += (r5 - a7) / 2;
  }
  return { x: c10, y: s6 };
};
var z4 = function(t7) {
  var e8, i5, n6, o5, r5, l5, a7 = t7.direction, c10 = t7.justify, s6 = t7.symbolSize, d4 = t7.symbolSpacing, h2 = t7.width, g2 = t7.height;
  switch (a7) {
    case "left-to-right":
      e8 = 0, i5 = (g2 - s6) / 2, o5 = g2 / 2, l5 = "central", c10 ? (n6 = h2, r5 = "end") : (n6 = s6 + d4, r5 = "start");
      break;
    case "right-to-left":
      e8 = h2 - s6, i5 = (g2 - s6) / 2, o5 = g2 / 2, l5 = "central", c10 ? (n6 = 0, r5 = "start") : (n6 = h2 - s6 - d4, r5 = "end");
      break;
    case "top-to-bottom":
      e8 = (h2 - s6) / 2, i5 = 0, n6 = h2 / 2, r5 = "middle", c10 ? (o5 = g2, l5 = "alphabetic") : (o5 = s6 + d4, l5 = "text-before-edge");
      break;
    case "bottom-to-top":
      e8 = (h2 - s6) / 2, i5 = g2 - s6, n6 = h2 / 2, r5 = "middle", c10 ? (o5 = 0, l5 = "text-before-edge") : (o5 = g2 - s6 - d4, l5 = "alphabetic");
  }
  return { symbolX: e8, symbolY: i5, labelX: n6, labelY: o5, labelAnchor: r5, labelAlignment: l5 };
};
var O3 = { circle: v3, diamond: u4, square: p3, triangle: y4 };
var B2 = function(i5) {
  var n6, o5, r5, a7, d4, m3, f4, v4, u5, p4, y5, x3 = i5.x, S3 = i5.y, A4 = i5.width, C5 = i5.height, W3 = i5.data, w3 = i5.direction, X = void 0 === w3 ? k4.itemDirection : w3, Y = i5.justify, B3 = void 0 === Y ? k4.justify : Y, H2 = i5.textColor, E4 = i5.background, j4 = void 0 === E4 ? "transparent" : E4, L2 = i5.opacity, M3 = void 0 === L2 ? 1 : L2, P4 = i5.symbolShape, F2 = void 0 === P4 ? k4.symbolShape : P4, T2 = i5.symbolSize, V2 = void 0 === T2 ? k4.symbolSize : T2, D2 = i5.symbolSpacing, R2 = void 0 === D2 ? k4.symbolSpacing : D2, q = i5.symbolBorderWidth, G = void 0 === q ? 0 : q, I = i5.symbolBorderColor, _2 = void 0 === I ? "transparent" : I, J = i5.onClick, K2 = i5.onMouseEnter, N2 = i5.onMouseLeave, Q = i5.toggleSerie, U = i5.effects, Z = (0, import_react21.useState)({}), $ = Z[0], tt2 = Z[1], et2 = z(), it2 = (0, import_react21.useCallback)(function(t7) {
    if (U) {
      var e8 = U.filter(function(t8) {
        return "hover" === t8.on;
      }).reduce(function(t8, e9) {
        return b3({}, t8, e9.style);
      }, {});
      tt2(e8);
    }
    null == K2 || K2(W3, t7);
    ...
    null == N2 || N2(W3, t7);
  }, [N2, W3, U]), ot2 = z4({ direction: X, justify: B3, symbolSize: null != (n6 = $.symbolSize) ? n6 : V2, symbolSpacing: R2, width: A4, height: C5 }), rt2 = ot2.symbolX, lt = ot2.symbolY, at2 = ot2.labelX, ct2 = ot2.labelY, st2 = ot2.labelAnchor, dt2 = ot2.labelAlignment, ht2 = [J, K2, N2, Q].some(function(t7) {
    return void 0 !== t7;
  }), gt2 = "function" == typeof F2 ? F2 : O3[F2];
  return (0, import_jsx_runtime5.jsxs)("g", { transform: "translate(" + x3 + "," + S3 + ")", style: { opacity: null != (o5 = $.itemOpacity) ? o5 : M3 }, children: [(0, import_jsx_runtime5.jsx)("rect", { width: A4, height: C5, fill: null != (r5 = $.itemBackground) ? r5 : j4, style: { cursor: ht2 ? "pointer" : "auto" }, onClick: function(t7) {
    null == J || J(W3, t7), null == Q || Q(W3.id);
  }, onMouseEnter: it2, onMouseLeave: nt }), l4.createElement(gt2, b3({ id: W3.id, x: rt2, y: lt, size: null != (a7 = $.symbolSize) ? a7 : V2, fill: null != (d4 = null != (m3 = W3.fill) ? m3 : W3.color) ? d4 : "black", borderWidth: null != (f4 = $.symbolBorderWidth) ? f4 : G, borderColor: null != (v4 = $.symbolBorderColor) ? v4 : _2 }, W3.hidden ? et2.legends.hidden.symbol : void 0)), (0, import_jsx_runtime5.jsx)(d2, { textAnchor: st2, style: b3({}, et2.legends.text, { fill: null != (u5 = null != (p4 = null != (y5 = $.itemTextColor) ? y5 : H2) ? p4 : et2.legends.text.fill) ? u5 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, W3.hidden ? et2.legends.hidden.text : void 0), x: at2, y: ct2, children: W3.label })] });
};
var H = function(e8) {
  var i5 = e8.data, n6 = e8.x, o5 = e8.y, r5 = e8.direction, l5 = e8.padding, a7 = void 0 === l5 ? k4.padding : l5, c10 = e8.justify, s6 = e8.effects, d4 = e8.itemWidth, h2 = e8.itemHeight, g2 = e8.itemDirection, m3 = void 0 === g2 ? k4.itemDirection : g2, f4 = e8.itemsSpacing, v4 = void 0 === f4 ? k4.itemsSpacing : f4, u5 = e8.itemTextColor, p4 = e8.itemBackground, y5 = void 0 === p4 ? "transparent" : p4, b4 = e8.itemOpacity, x3 = void 0 === b4 ? 1 : b4, S3 = e8.symbolShape, C5 = e8.symbolSize, z5 = e8.symbolSpacing, W3 = e8.symbolBorderWidth, w3 = e8.symbolBorderColor, X = e8.onClick, Y = e8.onMouseEnter, O4 = e8.onMouseLeave, H2 = e8.toggleSerie, E4 = A3({ itemCount: i5.length, itemWidth: d4, itemHeight: h2, itemsSpacing: v4, direction: r5, padding: a7 }).padding, j4 = "row" === r5 ? d4 + v4 : 0, L2 = "column" === r5 ? h2 + v4 : 0;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + n6 + "," + o5 + ")", children: i5.map(function(e9, i6) {
    return (0, import_jsx_runtime5.jsx)(B2, { data: e9, x: i6 * j4 + E4.left, y: i6 * L2 + E4.top, width: d4, height: h2, direction: m3, justify: c10, effects: s6, textColor: u5, background: y5, opacity: x3, symbolShape: S3, symbolSize: C5, symbolSpacing: z5, symbolBorderWidth: W3, symbolBorderColor: w3, onClick: X, onMouseEnter: Y, onMouseLeave: O4, toggleSerie: H2 }, i6);
  }) });
};
var E3 = function(e8) {
  var i5 = e8.data, n6 = e8.containerWidth, o5 = e8.containerHeight, r5 = e8.translateX, l5 = void 0 === r5 ? k4.translateX : r5, a7 = e8.translateY, c10 = void 0 === a7 ? k4.translateY : a7, s6 = e8.anchor, d4 = e8.direction, h2 = e8.padding, g2 = void 0 === h2 ? k4.padding : h2, m3 = e8.justify, f4 = e8.itemsSpacing, v4 = void 0 === f4 ? k4.itemsSpacing : f4, u5 = e8.itemWidth, p4 = e8.itemHeight, y5 = e8.itemDirection, b4 = e8.itemTextColor, x3 = e8.itemBackground, S3 = e8.itemOpacity, z5 = e8.symbolShape, W3 = e8.symbolSize, w3 = e8.symbolSpacing, X = e8.symbolBorderWidth, Y = e8.symbolBorderColor, O4 = e8.onClick, B3 = e8.onMouseEnter, E4 = e8.onMouseLeave, j4 = e8.toggleSerie, L2 = e8.effects, M3 = A3({ itemCount: i5.length, itemsSpacing: v4, itemWidth: u5, itemHeight: p4, direction: d4, padding: g2 }), P4 = M3.width, F2 = M3.height, T2 = C4({ anchor: s6, translateX: l5, translateY: c10, containerWidth: n6, containerHeight: o5, width: P4, height: F2 }), V2 = T2.x, D2 = T2.y;
  return (0, import_jsx_runtime5.jsx)(H, { data: i5, x: V2, y: D2, direction: d4, padding: g2, justify: m3, effects: L2, itemsSpacing: v4, itemWidth: u5, itemHeight: p4, itemDirection: y5, itemTextColor: b4, itemBackground: x3, itemOpacity: S3, symbolShape: z5, symbolSize: W3, symbolSpacing: w3, symbolBorderWidth: X, symbolBorderColor: Y, onClick: O4, onMouseEnter: B3, onMouseLeave: E4, toggleSerie: "boolean" == typeof j4 ? void 0 : j4 });
};
var j3 = { start: "left", middle: "center", end: "right" };
var L = function(t7, e8) {
  var i5 = e8.data, n6 = e8.containerWidth, o5 = e8.containerHeight, r5 = e8.translateX, l5 = void 0 === r5 ? 0 : r5, a7 = e8.translateY, c10 = void 0 === a7 ? 0 : a7, s6 = e8.anchor, d4 = e8.direction, h2 = e8.padding, g2 = void 0 === h2 ? 0 : h2, v4 = e8.justify, u5 = void 0 !== v4 && v4, p4 = e8.itemsSpacing, y5 = void 0 === p4 ? 0 : p4, k5 = e8.itemWidth, x3 = e8.itemHeight, S3 = e8.itemDirection, W3 = void 0 === S3 ? "left-to-right" : S3, w3 = e8.itemTextColor, X = e8.symbolSize, Y = void 0 === X ? 16 : X, O4 = e8.symbolSpacing, B3 = void 0 === O4 ? 8 : O4, H2 = e8.theme, E4 = A3({ itemCount: i5.length, itemWidth: k5, itemHeight: x3, itemsSpacing: y5, direction: d4, padding: g2 }), L2 = E4.width, M3 = E4.height, P4 = E4.padding, F2 = C4({ anchor: s6, translateX: l5, translateY: c10, containerWidth: n6, containerHeight: o5, width: L2, height: M3 }), T2 = F2.x, V2 = F2.y, D2 = "row" === d4 ? k5 + y5 : 0, R2 = "column" === d4 ? x3 + y5 : 0;
  t7.save(), t7.translate(T2, V2), f3(t7, H2.legends.text), i5.forEach(function(e9, i6) {
    var n7, o6 = i6 * D2 + P4.left, r6 = i6 * R2 + P4.top, l6 = z4({ direction: W3, justify: u5, symbolSize: Y, symbolSpacing: B3, width: k5, height: x3 }), a8 = l6.symbolX, c11 = l6.symbolY, s7 = l6.labelX, d5 = l6.labelY, h3 = l6.labelAnchor, g3 = l6.labelAlignment;
    t7.fillStyle = null != (n7 = e9.color) ? n7 : "black", t7.fillRect(o6 + a8, r6 + c11, Y, Y), t7.textAlign = j3[h3], "central" === g3 && (t7.textBaseline = "middle"), u3(t7, b3({}, H2.legends.text, { fill: null != w3 ? w3 : H2.legends.text.fill }), String(e9.label), o6 + s7, r6 + d5);
  }), t7.restore();
};
var P3 = function(t7) {
  var e8 = t7.scale, i5 = t7.domain, n6 = t7.reverse, o5 = void 0 !== n6 && n6, r5 = t7.valueFormat, l5 = void 0 === r5 ? function(t8) {
    return t8;
  } : r5, a7 = t7.separator, c10 = void 0 === a7 ? " - " : a7;
  return (0, import_react21.useMemo)(function() {
    var t8 = (null != i5 ? i5 : e8.range()).map(function(t9, i6) {
      var n7 = e8.invertExtent(t9), o6 = n7[0], r6 = n7[1];
      return { id: t9, index: i6, extent: [o6, r6], label: "" + l5(o6) + c10 + l5(r6), value: e8(o6), color: t9 };
    });
    return o5 && t8.reverse(), t8;
  }, [i5, e8, o5, c10, l5]);
};
...
//# sourceMappingURL=chunk-SJB3HMNW.js.map
