...
export declare const StreamLayer: <RawDatum extends StreamDatum>({ layer, fillOpacity, borderWidth, getBorderColor, isInteractive, tooltip, }: StreamLayerProps<RawDatum>) => import("react/jsx-runtime").JSX.Element;
export {};
