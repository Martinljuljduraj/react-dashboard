...
export declare const StreamDots: <RawDatum extends StreamDatum>({ data, dotComponent, position, getSize, getColor, getBorderWidth, getBorderColor, }: StreamDotsProps<RawDatum>) => import("react/jsx-runtime").JSX.Element;
export {};
