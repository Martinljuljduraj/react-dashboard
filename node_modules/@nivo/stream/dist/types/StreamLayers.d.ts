...
export declare const StreamLayers: <RawDatum extends StreamDatum>({ layers, fillOpacity, borderWidth, getBorderColor, isInteractive, tooltip, }: StreamLayersProps<RawDatum>) => import("react/jsx-runtime").JSX.Element;
export {};
