...
export declare const StreamSlicesItem: <RawDatum extends StreamDatum>({ slice, height, tooltip, }: StreamSlicesItemProps<RawDatum>) => import("react/jsx-runtime").JSX.Element;
export {};
